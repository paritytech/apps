  ...
  return (
    <>
      ...
      <Modal className={className} isOpen={isOpen} onClose={toggleIsOpen}>
        ...
        <Modal.Content>
          <p>{t<string>("You are about to remove this contract from your list of available contracts. Once completed, should you need to access it again, you will have to manually add the contract's address in the Execute tab.")}</p>
