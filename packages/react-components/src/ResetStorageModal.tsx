...
function ResetStorageModal({ className }: BareProps): React.ReactElement<BareProps> {
  ...
  return (
    <Modal className={className} isOpen={isOpen} onClose={_onClose}>
      ...
      <Modal.Content>
        <p>{t('It appears your currently running development chain and the UI artifacts are out of sync. This can happen after purging and restarting the chain. Do you want to reset your browser storage? This will remove all previously added code bundles and deployed contracts.')}</p>
      </Modal.Content>
